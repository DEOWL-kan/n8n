			...
			model_services: [
				{
					...
					supported_api_types: ['openai/v1/chat/completions', 'mlflow/v1/chat/completions'],
				},
				{
					name: 'model-services/system.ai.gte-large-en',
					supported_api_types: ['openai/v1/embeddings', 'mlflow/v1/embeddings'],
				},
				{
				...
				{
					name: 'model-services/main.ml.mlflow-only',
